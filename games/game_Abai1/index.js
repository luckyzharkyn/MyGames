let question = {
    ...
    9: {
        ...
        answers: {
            1: "Четвёртый сын Турагул (общественный деятель партии «Алаш Орда», поэт и писатель, по собственному утверждению перевёл на казахский язык произведения Джека Лондона «Эскимос Киш» и «Мартин Иден».",
            2: "Акылбай",
            3: "Сын Абдирахман"
        },
        correctAnswer: "Четвёртый сын Турагул (общественный деятель партии «Алаш Орда», поэт и писатель, по собственному утверждению перевёл на казахский язык произведения Джека Лондона «Эскимос Киш» и «Мартин Иден»."
    },
    10: {
        TextQuestion: "Как имя племянника – поэта, писателя, автора книги «Зеркало казахов», поэм «Калкаман-Мамыр» и «Енлик-Кебек»?",
        answers: {
            1: "Дулат",
            2: "Какитай",
            3: "Племянник Шакарим — поэт, писатель, переводчик, композитор, историк и философ. Перевёл «Дубровского» и «Метель» А. С. Пушкина"
        },
        correctAnswer: "Племянник Шакарим — поэт, писатель, переводчик, композитор, историк и философ. Перевёл «Дубровского» и «Метель» А. С. Пушкина"
    },
    11: {
...
function SaveName() {
    let mass = [];
    let mass2 = returnMass();
    mass[0] = playerName.value;
    localStorage.setItem
}

function returnMass() {
    let mass = [];
    mass[0] = countRightAnswer;
    mass[1] = countIncorrectAnswer;
    return mass;
}
    
/*
1. При выборе одного из ответов:
1.1 следующий вопрос должен появится через 3 секунды+
1.2 другие ответы должны заблокироваться+
1.3 правильный ответ должен загореться зеленым, а остальные красным+
1.4 картинка должна менятся в каждом вопросе



последний и 9 вопрос нужно переделать
*/
